...
DECLARE
    v_rs_cur SYS_REFCURSOR; --OPEN, CLOSE 생략가능 빌트인커서
...
BEGIN
    p_pro_add('강홍묵','강홍묵','ccc',200,1,200,'2022/08/31','2022/09/30','강홍묵',
    1,'PRO_ING','사진.jpg','사진-1.jpg',
    500,'IMAGE','d:/jmh/upload/',
    '사진_thumb.jpg',200,'d:/jmh/upload/thumb/',PRO_SEQNO);
...
begin
    P_PRO_MODIFY('PRO_ING',200,1,20,'2022/08/31','2022/09/30','강홍묵2',19,1,'강홍묵','강홍묵',30);
end;
...
BEGIN
    p_orderadd('point','강홍묵','010','ORD20220912-121036183','100000','ccc',p_cart_seqno,p_cart_amount,v_seqno);
